...
<body>
   <section class="row mx-3 text-center justify-content-around  mt-5 main">
   <div class="div1 col-5 mt-5">
             <button type="submit" class="w-75 fs-3 btn btn1 fw-bold shadow "><a href="addstaff.jsp" class="   text-white">Add Staff</a></button>     
       </div>
       <div class="div2 col-5 mt-5">
             <button type="submit" class="w-75 fs-3 btn btn2 fw-bold shadow "><a href="viewstaff.jsp" class="  text-white"> Available Staff</a></button>     
       </div>
       
         <div class="div3 col-5 mt-5">
             <button type="submit" class="w-75 fs-3 btn btn3 fw-bold shadow  "><a href="showuser.jsp" class="  text-white">Check Users</a></button>     
       </div>
       <div class="div4 col-5 mt-5">
             <button type="submit" class="w-75 fs-3 btn btn4 fw-bold shadow  "><a href="showbookedrooms.jsp" class="  text-white"> Booked Rooms</a></button>     
       </div>
       <div class="div5 col-5 mt-5">
             <button type="submit" class="w-75 fs-3 btn btn6 fw-bold shadow  "><a href="showbookedhall.jsp" class="  text-white">Booked Halls</a></button>     
       </div>
   </section>
   <section class="footerr  text-white text-center px-5 mx-4 py-3 mt-4">
    <div>
          <div>
