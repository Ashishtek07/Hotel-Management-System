...
<body>
  ...
  <div id="Checkout" class="inline">
      <h1 class="fw-bold text-white">Pay Invoice</h1>
      <div class="card-row">
      ...
      <form method="" action="" class="">
          ...
          <button id="PayButton" class="btn btn-block btm text-dark fw-bold  mt-4 ps-0 px-3 shadow" type="submit">
              <span class="submit-button-lock text-black"></span>
 ...
 <section class="footerr  text-white text-center px-5 mx-4 py-3 mt-5">
    <div>
          <div>
