...
<style>
 body {
  ...
  <h1 class="text-secondary fw-bold ">Hall Booking Form</h1>

  <form action="hallbookform" method="get" class="shadow-lg">
    ...
    <select id="room-type" name="halltype">
      <option value="single">Conference</option>
      <option value="double">Marriage</option>
      <option value="suite"></option>
    </select>

    <div class="text-center "><input type="submit" value="Submit" class="shadow"></div>
  </form>
